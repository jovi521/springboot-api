...
import com.example.springdoc.component.ApplicationProperties;
...
public class SpringDocOpenapiConfig implements WebMvcConfigurer {
    ...
    @Autowired
    public SpringDocOpenapiConfig(ApplicationProperties applicationProperties) {
    ...
    public OpenAPI springDocOpenAPI() {
        ...
        tryServer.setUrl(applicationProperties.getTryHost());

        return new OpenAPI()
                .components(components)
                .servers(Collections.singletonList(tryServer))
                .info(new Info()
                        .title(applicationProperties.getApplicationName() + " Api Doc")
                        .description(applicationProperties.getApplicationDescription())
                        .version("Application Version: " + applicationProperties.getApplicationVersion() + "\n Spring Boot Version: " + SpringBootVersion.getVersion())
